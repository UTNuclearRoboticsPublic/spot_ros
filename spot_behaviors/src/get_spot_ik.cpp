...
BT::NodeStatus GetSpotIK::onRunning() {
    ...
    switch (status){
        ...
        case rclcpp::FutureReturnCode::SUCCESS:
            ...
            auto body_pose = std::make_shared<geometry_msgs::msg::PoseStamped>();
            body_pose->pose = resp->body_pose;
            body_pose->header.frame_id = "base_footprint";
            setOutput("body_pose", body_pose);
