...
BT::PortsList RecordCurrentLocation::providedPorts() {
    return {
        ...
        BT::OutputPort<std::shared_ptr<geometry_msgs::msg::PoseStamped>>("recorded_pose", "The measured pose")
    };
}
...
BT::NodeStatus RecordCurrentLocation::tick() {
    ...
    std::shared_ptr<geometry_msgs::msg::PoseStamped> frame_pose;
    ...
    setOutput<std::shared_ptr<geometry_msgs::msg::PoseStamped>>("recorded_pose", frame_pose);
