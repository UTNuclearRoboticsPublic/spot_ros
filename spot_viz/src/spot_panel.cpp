...
namespace spot_viz
{
    ...
    ControlPanel::ControlPanel(QWidget *parent) {
        ...
        stowArmService_ = nh_.serviceClient<std_srvs::Trigger>("spot/arm_stow");
        unstowArmService_ = nh_.serviceClient<std_srvs::Trigger>("spot/arm_unstow");
        ...
        stowArmButton = this->findChild<QPushButton*>("stowArmButton");
        unstowArmButton = this->findChild<QPushButton*>("unstowArmButton");
        ...
        connect(stowArmButton, SIGNAL(clicked()), this, SLOT(stowArm()));
        connect(unstowArmButton, SIGNAL(clicked()), this, SLOT(unstowArm()));
    }
    ...
    void ControlPanel::setControlButtons() {
        ...
        stowArmButton->setEnabled(haveLease);
        unstowArmButton->setEnabled(haveLease);
    }
    ...
    void ControlPanel::powerCallback(const spot_msgs::PowerState::ConstPtr &power) {
        ...
        case spot_msgs::PowerState::STATE_POWERING_OFF:
            ...
            stowArmButton->setEnabled(false);
            unstowArmButton->setEnabled(false);
            break;
        case spot_msgs::PowerState::STATE_ON:
            ...
            stowArmButton->setEnabled(true);
            unstowArmButton->setEnabled(true);
            break;
    ...
    void ControlPanel::stowArm() {
        callTriggerService(stowArmService_, "arm stow");
    }

    void ControlPanel::unstowArm() {
        callTriggerService(unstowArmService_, "arm unstow");
    }
